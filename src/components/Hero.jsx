function Hero({ business }) {
  const whatsappMessage = encodeURIComponent(
    "Hi, I'd like to ask about your seafood menu / availability.",
  );
  ...
  return (
    <section className="relative min-h-[70vh] md:min-h-[85vh] flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://www.amexessentials.com/wp-content/uploads/2025/05/seaside-festivals-flavours.jpg)",
        }}
      ></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fadeIn">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500">
              <img
                src="https://images.stockcake.com/public/e/c/5/ec5be589-218c-41aa-bd46-12d1c852bd62_large/seaside-cooking-pot-stockcake.jpg"
                alt="Fresh Seafood"
